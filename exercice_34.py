...
# demander un nombre aléatoirement

nombre_aletoirement = 5

# activer le jeu

running = True

#tant que le jeu est est activer

while running:
    #demander a l'utilisateur d'entrer un nombre

    nombre = int(input("deviner un nombre entre 1 a 100 : "))

    #si nombre est egal nombre aleatoire

    if nombre < nombre_aletoirement:
        print("un peu plus")
    elif nombre == nombre_aletoirement:
